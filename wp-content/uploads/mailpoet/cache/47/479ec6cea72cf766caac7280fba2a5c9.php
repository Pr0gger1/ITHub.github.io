...
/* newsletters.html */
class __TwigTemplate_d33f7b23789bf972428c82328f08673f extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <script type=\"text/javascript\">
    ";
      ...
      var mailpoet_display_nps_poll = ";
        // line 11
        echo ((((($context["sent_newsletters_count"] ?? null) > 0) && \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "display_nps_poll", [], "any", false, false, false, 11))) ? ("true") : ("false"));
        echo ";
      ...
      var mailpoet_send_transactional_emails = ";
        // line 67
        echo json_encode((\MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "send_transactional_emails", [], "any", false, false, false, 67) == "1"));
        echo ";
...
";
  ...
  ";
        // line 454
        $this->loadTemplate("mss_pitch_translations.html", "newsletters.html", 454)->display($context);
    }
